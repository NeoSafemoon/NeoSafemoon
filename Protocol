...
/*
    ...
    NEO SAFEMOON IS A CHARITY TOKEN 
    ...
    Telegram: https://t.me/Neosafemoon
    Twitter: https://twitter.com/NSafemoon
    Website: https://neosafemoon.com/
...
contract Neosafemoon is Context, IERC20, Ownable {
    ...
    string private _name = "Neo Safemoon";
